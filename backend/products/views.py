...
from products.models import Product, get_model_schema
...
class ProductView(APIView):
    ...
    def get(self, request):
        if request.query_params.get("schema") == "true":
            return success_response(
                ...
                data={
                    "fields": get_model_schema(Product),
                },
            )
        transaction_type = (
        ...
        try:
            rows, count = product_service.list_transactions(
                user=request.user,
        ...
        return paginated_response(
            ...
            results=ProductListSerializer(rows, many=True).data,
            count=count,
            request=request,
            offset=offset,
            limit=limit,
    ...
    def post(self, request):
        ...
        transaction = product_service.create_transaction(
            user=request.user,
        ...
        return success_response(
            ...
            data=ProductListSerializer(transaction).data,
        )
