"""
Purchase Order extraction prompts for Gemini.

Provides the system persona and the structured extraction prompt used
for Purchase Order documents. Returns a JSON object with PO-specific
fields and per-field confidence.
"""

from __future__ import annotations

#: System-level persona for Purchase Order extraction.
SYSTEM_PROMPT: str = (
    "You are a precise purchase order OCR extraction engine. "
    "Your only task is to read purchase order images and extract structured data. "
    "You never invent data, never guess, never add explanations."
)

#: The main purchase order extraction prompt.
EXTRACTION_PROMPT: str = (
    "Extract the following fields from this purchase order image."
    ...
    "}\n\n"
    "Rules:\n"
    "1. Preserve exact values as they appear on the purchase order.\n"
