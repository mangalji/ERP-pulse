export const API_BASE = import.meta.env.VITE_API_BASE_URL || (import.meta.env.PROD ? 'https://agsuite-backend-app-50045691128.development.catalystappsail.in/api/v1' : 'http://localhost:8000/api/v1')
